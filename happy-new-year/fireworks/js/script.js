...
const helpContent = {
	shellType: {
		header: '烟花类型',
		body: '决定会发射哪种形状的烟花。 选择“随机”以获得最丰富多彩的体验。'
	},
	shellSize: {
		header: '烟花大小',
		body: '顾名思义。 与现实型号对应，大烟花会有更大的半径和更多的星星，同时可能会有更复杂的效果。 但是更大的烟花也会消耗更多的算力，可能会带来更多卡顿。'
	},
	quality: {
		header: '渲染质量',
		body: '整体画面质量。 如果动画不是很丝滑，试试降低这一项。 高质量会显著提升火花的数量，但可能造成卡顿。'
	},
	skyLighting: {
		header: '照亮夜空',
		body: '烟花爆炸时是否照亮背景。 如果在你的屏幕上背景看起来过亮，试试调整为“轻微”或“不要”。'
	},
	scaleFactor: {
		header: '缩放',
		body: '整体缩放所有烟花，也就是在近处看或者在远处看（近大远小）。 对于大尺寸烟花，适当缩小一些会有更好的效果，尤其是在移动设备上。'
	},
	autoLaunch: {
		header: '表演模式',
	...
	hideControls: {
		header: '隐藏控件',
		body: '隐藏屏幕上方的所有半透明按钮。 用来截屏录屏的话非常有用，亦或单纯来一场纯粹的沉浸式体验。 隐藏后，你仍然可以点击屏幕右上角来重新打开该菜单。'
	},
	fullscreen: {
		header: '全屏',
		body: '全屏，启动！'
...
function init(str) {
	...
	setOptionsForSelect(appNodes.skyLighting, [
		{ label: '不要', value: SKY_LIGHT_NONE },
		{ label: '轻微', value: SKY_LIGHT_DIM },
