...
const helpContent = {
	shellType: {
		header: '烟花类型',
		body: '决定会发射哪种形状的烟花。 选择“随机”已获得最丰富多彩的体验。'
	},
	shellSize: {
		header: '烟花大小',
		body: '顾名思义。 与现实型号对应，大烟花会有更大的半径和更多的星星，也可能会有更复杂的效果。 但是更大的烟花也会消耗更多的算力，可能会带来更多卡顿。'
	},
	quality: {
		header: '渲染质量',
	...
	hideControls: {
		header: '隐藏控件',
		body: '隐藏屏幕上方的所有半透明按钮。 用来截屏录屏的话非常有用，或者来一场纯粹的沉浸式体验。 隐藏后，你仍然可以点击屏幕右上角来重新打开菜单。'
	},
	fullscreen: {
		header: '全屏',
		body: '全屏，启动！'
